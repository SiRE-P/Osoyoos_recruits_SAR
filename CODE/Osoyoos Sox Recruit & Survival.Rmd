...
# write.csv(returns_select,"../data/returns_select_SIS240212_xlsx_240526.csv")                                           # if SIS xlsx data imported, re-write to CSV

returns_select <- read.csv("../DATA/returns_select_SIS240212_xlsx_240526.csv")                                           # replaces import data from SIS workbook [240510]
```
...
age_data <- read_xlsx("../DATA/SIS - Data - OSOYOOS - 24.05.17.xlsx", sheet = "Data at Age") %>%
  dplyr::select(return_year = `Return Year`, prop_Fryer = `Age Comp (Fryer)`, 
                prop_SIRE = `Age Comp (SIRE)`, Age, best_source = `Best Source`, Comments)

...
ggplot(data = filter(spawning_location_compare, prop_sock_type != "Unresolved"), aes(x=year)) +
  ...
  geom_point(aes(y = p_sock_deadp, color = prop_sock_type, shape = prop_sock_type), size=2) +
  scale_shape_manual(values = c(0, 22, 19)) +  # Set shapes: 0 = square, 22 = filled square, 21 = filled circle with border

...
report_table1 <- columbia_okanagan_recruits %>%
# mutate("Total Proportions" = prop_oso_origin_nat + prop_ska_origin_nat + prop_hatch_origin) %>%
  dplyr::select(Year=return_year, 
                ...
                "Osoyoos N-O Proportion (%)" = prop_oso_origin_nat,
                "Skaha N-O Proportion(%)" = prop_ska_origin_nat,
                "Hatchery Origin (H-O) Proportion (%)" = prop_hatch_origin,
#               "Total Proportions",
                "Osoyoos N-O Recruits" = oso_total_recruits)

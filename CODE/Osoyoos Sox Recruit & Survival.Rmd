...
write.csv(AUC_data_Import,  "../data/AUC_data_Import_250623.csv")        # if AUC_data imported from AO xlsx workbook, re-write to CSV   # comment out for GitHub
auc_data_import <- read.csv("../data/AUC_data_Import_250623.csv")        # export and re-import (NOTE lower-case dataset name) --- keep for GitHub [241128]

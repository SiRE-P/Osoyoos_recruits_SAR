...
juv_dat <- read_excel("../data/SIS - Data - OSOYOOS - 24.05.17.xlsx", sheet = "Juvenile Data") #presmolt (was 24.05.13.xlsx) [hs: 240426]
# #Pre-smolt abundance
...
write.csv(j_dat,  "../data/juv_dat_xlsx_240517.csv")    # if juv data imported, re-write to CSV  # comment out for GitHub

j_dat <- read.csv("../data/juv_dat_xlsx_240517.csv")    # replaces import data from SIS-OSO xlsx workbook # keep for GitHub [240510]
...
radat2 <- radat %>%
  ...
  filter(s_year > 1997) %>%                                                     #no juvenile abund data prior to 1998

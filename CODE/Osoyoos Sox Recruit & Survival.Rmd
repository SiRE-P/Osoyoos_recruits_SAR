...
auc_data_import <- read.csv("../data/AUC_data_Import_241128.csv")        # keep for GitHub [241128]
...
ggplot(spawning_location_compare %>% filter(sockeye_est != "Unresolved"), aes(x=year)) +
  ...
  geom_point(aes(y = total_sockeye, color = sockeye_est), size=2) +
  scale_color_manual(values = c("Assumed"="gray50", "Imputed"="red", "Observed"="black")) +
